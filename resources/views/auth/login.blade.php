                                ...
                                <div class="card-body p-4">
                                    <div class="mb-4 pb-2 pt-4">
                                        <a href="index" class="d-block auth-logo">
                                            <img src="{{ URL::asset('build/images/actores/logo-dark.png') }}" alt=""
                                                height="30" class="auth-logo-dark me-start">
                                            <img src="{{ URL::asset('build/images/actores/logo-light.png') }}"
                                                alt="" height="30" class="auth-logo-light me-start">
                                        </a>
                                    </div>
                                    <div class="text-center mt-2">
                                        <h5>"¡Nos alegra verte de nuevo!</h5>
                                        <p class="text-muted">Accede para seguir en Actores360.</p>
                                    </div>
                                    <div class="p-2 mt-4">
                                        <form method="POST" action="{{ route('login') }}" class="auth-input">
                                            ...
                                            <div class="mb-3">
                                                <div class="float-end d-none">
                                                    <a href="{{ route('password.update') }}"
                                                        class="text-muted text-decoration-underline">¿Has olvidado tu
                                                        contraseña?</a>
                                                </div>
                                                ...
                                                <div class="position-relative auth-pass-inputgroup input-custom-icon">
                                                    ...
                                                    <input type="password"
                                                        ...
                                                        placeholder="Introducir la contraseña" id="password-input" name="password"
                                            ...
                                            <div class="mt-4 text-center d-none">
                                                <div class="signin-other-title">
                                                    <h5 class="font-size-14 mb-3 mt-2 title"> Iniciar sesión con </h5>
                                                </div>

                                                <ul class="list-inline mt-2 d-none">
                        ...
                        <div class="col-lg-12">
                            <div class="text-center p-4">
                                <p>©
                                    ...
                                    </script> Actores Sociedad Colombiana de Gestión.
                                </p>
                            </div>
                        </div>
                    </div>
